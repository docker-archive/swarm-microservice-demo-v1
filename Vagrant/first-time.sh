...
vagrant ssh -c "sudo apt-get install -y linux-image-generic-lts-utopic && sudo reboot" web01
vagrant ssh -c "sudo apt-get install -y linux-image-generic-lts-utopic && sudo reboot" worker01
vagrant ssh -c "sudo apt-get install -y linux-image-generic-lts-utopic && sudo reboot" pg
